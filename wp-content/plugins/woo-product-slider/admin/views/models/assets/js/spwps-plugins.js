...
(function($) {
  ...
  function SPWPSAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  SPWPSAjaxChosen.prototype.init = function() {
  ...
  SPWPSAjaxChosen.prototype.events = function() {
  ...
  SPWPSAjaxChosen.prototype.search_field_focused = function() {
  ...
  SPWPSAjaxChosen.prototype.search_welcome_message = function() {
  ...
  SPWPSAjaxChosen.prototype.update_list = function() {
  ...
  SPWPSAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.spwps-hidden-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.SPWPSChosenOrder($hidden_value, true);
  ...
  $.fn.SPWPSAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new SPWPSAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, SPWPSAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  SPWPSAbstractChosenOrder = (function() {

    function SPWPSAbstractChosenOrder() {}

    SPWPSAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    SPWPSAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    SPWPSAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    SPWPSAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    SPWPSAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    SPWPSAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    SPWPSAbstractChosenOrder.SPWPSChosenOrder = function(select, order, force) {
    ...
    return SPWPSAbstractChosenOrder;
  ...
  $.fn.extend({
    SPWPSChosenOrder: function(order, force) {
      return _SPWPSChosenOrder.SPWPSChosenOrder(this, order, force);
    }
  });

  this._SPWPSChosenOrder = (function(_super) {
    __extends(_SPWPSChosenOrder, _super);

    function _SPWPSChosenOrder() {
      _ref = _SPWPSChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _SPWPSChosenOrder.relAttributeName = 'data-option-array-index';

    _SPWPSChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _SPWPSChosenOrder.getDOMElement = function(element) {
    ...
    _SPWPSChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _SPWPSChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _SPWPSChosenOrder;

  })(SPWPSAbstractChosenOrder);
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectSPWPS = FormSerializer.serializeObject;
    $.fn.serializeJSONSPWPS   = FormSerializer.serializeJSON;
  }
